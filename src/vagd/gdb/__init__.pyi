...
class GDB:
    def execute(self, command: str, from_tty: bool = ..., to_string: bool = ...) -> str | None: ...
    def breakpoints(self) -> Sequence[Breakpoint]: ...
    def rbreak(self, regex: str, minsyms: bool = ..., throttle: int = ..., symtabs: Iterator[Symtab] = ...) -> list[Breakpoint]: ...
    def parameter(self, __parameter: str) -> bool | int | str | None: ...
    def set_parameter(self, name: str, value: bool | int | str | None) -> None: ...
    def with_parameter(self, name: str, value: bool | int | str | None) -> AbstractContextManager[None]: ...
    def history(self, __number: int) -> Value: ...
    def add_history(self, __value: Value) -> int: ...
    def history_count(self) -> int: ...
    def convenience_variable(self, __name: str) -> Value | None: ...
    def set_convenience_variable(self, __name: str, __value: _ValueOrNative | None) -> None: ...
    def parse_and_eval(self, __expression: str) -> Value: ...
    def find_pc_line(self, pc: int | Value) -> Symtab_and_line: ...
    def post_event(self, __event: Callable[[], object]) -> None: ...
    def write(self, string: str, stream: int = ...) -> None: ...
    def flush(self, stream: int = ...) -> None: ...
    def target_charset(self) -> str: ...
    def target_wide_charset(self) -> str: ...
    def host_charset(self) -> str: ...
    def solib_name(self, address: int) -> str | None: ...
    def decode_line(self, __expression: str = ...) -> tuple[str | None, tuple[Symtab_and_line, ...] | None]: ...
    def prompt_hook(self, current_prompt: str) -> str: ...
